...
export default function NuevaOperacion() {
  ...
  const guardarOperacion = () => {
    // Lógica de guardado simplificada para demo
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-slate-50 p-4 md:p-8"> {/* Padding reducido en móvil */}
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 border border-slate-200">
            ...
            {paso === 1 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                {/* AQUÍ ESTABA EL ERROR: Cambiamos grid-cols-2 a grid-cols-1 en móvil */}
            ...
            {paso === 3 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="space-y-6">
                  ...
                  {/* AQUÍ TAMBIÉN CORREGIMOS EL GRID */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-bold text-slate-700 mb-2">País Origen</label>
